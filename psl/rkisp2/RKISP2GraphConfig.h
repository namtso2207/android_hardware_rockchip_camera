...
#ifndef _CAMERA3_RKISP2GraphConfig_H_
#define _CAMERA3_RKISP2GraphConfig_H_
...
const std::string CSI_BE = "rockchip-csi2-dphy0";
 ...
 * possibilities to single graph settings: the RKISP2GraphConfig object.
 *
 * This class is instantiated by \class RKISP2GraphConfigManager for each request,
...
public:
    ...
    /*
     * Convert Node to RKISP2GraphConfig interface
     */
    ...
    */
     ...
     */
    static void reset(RKISP2GraphConfig *me);
    void fullReset();
    /*
     * Debugging support
     */
...
public:
    ...
    friend class RKISP2GraphConfigManager;
    // Private initializer: only used by our friend RKISP2GraphConfigManager.
    void init(int32_t reqId);
    status_t prepare(RKISP2GraphConfigManager *manager,
                     Node *settings,
...
private:
    ...
    RKISP2GraphConfig(const RKISP2GraphConfig &);
...
private:
    RKISP2GraphConfigManager *mManager; /* RKISP2GraphConfig doesn't own mManager */
    ...
    /**
     *copy of the map provided from RKISP2GraphConfigManager to be used internally.
     */
