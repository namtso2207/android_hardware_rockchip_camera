...
#ifndef PSL_RKISP1_WORKERS_RKISP2FrameWorker_H_
#define PSL_RKISP1_WORKERS_RKISP2FrameWorker_H_
...
class RKISP2FrameWorker : public RKISP2IDeviceWorker
{
public:
    RKISP2FrameWorker(std::shared_ptr<V4L2VideoNode> node, int cameraId,
                size_t pipelineDepth, std::string name = "RKISP2FrameWorker");
...
protected:
    ...
    status_t setWorkerDeviceBuffers(int memType, bool cached);
...
#endif /* PSL_RKISP1_WORKERS_RKISP2FrameWorker_H_ */
